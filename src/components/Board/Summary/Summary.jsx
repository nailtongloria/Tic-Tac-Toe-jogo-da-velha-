/*
Criação do sumário que vem a baixo do tabuleiro do jogo da velha
*/
import React from 'react'
import { connect } from 'react-redux'
import { checkResult } from '../../../actions/resultsActions.js'
function Summary(props) {
    ...
    if (!(result.tie || result.win)) {
      ...
      /*
          Avisa quem ganhou o jogo, player 1 ou player 2
      */
      if (result.tie) {
